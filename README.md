...
- 가천대학교 스마트보안전공 재학 중 (2023 — 2027)
- **Information Security & Machine Learning Lab** 학부연구생 (2026 — 현재) · 양자내성암호(Post-Quantum Cryptography) 연구
- 심볼릭 실행 기반 LLM 에이전트를 통한 허니팟 스마트 컨트랙트 탐지 방법론 제안 — 한국정보보호학회 **제1저자**
- 가천대학교 학과 P-실무 프로젝트 **최우수상** (2025) — 브라우저 취약점 자동화 탐색을 위한 하이브리드 분석 프레임워크 연구
- 리눅스마스터 2급
...
<img src="https://img.shields.io/badge/IDA_Pro-6E4C9E?style=for-the-badge">
<img src="https://img.shields.io/badge/GDB-808080?style=for-the-badge&logo=gnu&logoColor=white">
...
**[browser](https://github.com/Hanboyunn/browser)**

WebIDL 기반 Chromium 의미 기반(semantic) 브라우저 퍼징 프레임워크

</td>
<td width="33%" valign="top">

**[a2a](https://github.com/Hanboyunn/a2a)**

Trust Score 기반 Agent-to-Agent 통신 보안 시스템 (서명 검증 · Replay 공격 탐지)

</td>
<td width="33%" valign="top">

**[osint](https://github.com/Hanboyunn/osint)**

MITRE ATT&CK / VirusTotal 연동 CTI(위협 인텔리전스) 조회 도구
...
<p align="center">
<img src="https://streak-stats.demolab.com/?user=Hanboyunn&theme=tokyonight&background=0F172A&stroke=1E293B&ring=3B82F6&fire=3B82F6&currStreakLabel=3B82F6&sideLabels=E2E8F0&currStreakNum=E2E8F0&sideNums=E2E8F0&dates=94A3B8" />
</p>
